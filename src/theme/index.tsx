...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bg2: darkMode ? '#121415' : '#F7F8FA',
    bg3: darkMode ? '#40444F' : '#EDEEF2',
    bg4: darkMode ? '#565A69' : '#CED0D9',
    bg5: darkMode ? '#ddd' : '#999',
    contentBg: darkMode ? '#000000' : white,
    navIconBg: darkMode ? '#363d5f' : 'rgba(0,0,0,0.05)',
    navBg: darkMode ? '#000000' : '#031a6e',
    navBg2: darkMode ? '#000000' : '#031a6e',
    bgColorLinear: 'linear-gradient(to right, #734ce2 , #606bfb)',
    outLinkIconBg: darkMode ? black : '#ecf6ff',
    bodyBg: darkMode ? '#151a2f' : '#f9fafb',
    tabBg: darkMode ? black : white,
    ...
    tipBg: darkMode ? black : '#f2edff',
    tipBorder: darkMode ? black : '#b398f9',
    tipColor: darkMode ? white : '#734be2',

    lightPuroleBg: darkMode ? black : 'rgb(246, 244, 255)',
    viewMoreBtn: darkMode ? black : '#f9fafb',

    selectedBg: darkMode ? black : '#ecf6ff',
    selectedHoverBg: darkMode ? '#252b49' : '#deefff',

    selectedBorder: darkMode ? '#363d5f' : '#c0d6ea',
    selectedHoverBorder: darkMode ? '#4a5482' : '#6d9cc6',

    selectedBgNo: darkMode ? black : '#f8f8f9',
